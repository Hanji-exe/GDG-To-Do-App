...
The **Sparky Todo App** works — but it's missing some features. Your task is to **extend it by minum of 2 NEW FEATURES** using everything you learned:
...
Good luck, Cadet! Sparky is rooting for you. 🫡
